    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    mptLocalMapping = new thread(&orbslam3::LocalMapping::Run,mpLocalMapper);
    ...
    mptLoopClosing = new thread(&orbslam3::LoopClosing::Run, mpLoopCloser);
...
void System::SaveTrajectoryTUM(const string &filename)
{
    ...
    list<orbslam3::KeyFrame*>::iterator lRit = mpTracker->mlpReferences.begin();
